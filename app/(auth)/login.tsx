...
// Use SVG URI from assets instead of inline XML
const DHEMAX_LOGO_PATH = require("@/assets/images/dhemax-logo.svg");
      ...
      <View style={{ flex: 1, paddingTop: insets.top, paddingBottom: insets.bottom }}>
        ...
        >
          ...
          <View style={{ alignItems: "center", marginBottom: spacing.xxl }}>
            ...
            >
              <SvgUri uri={DHEMAX_LOGO_PATH} width="100%" height="100%" />
            </View>
            <Text
              variant="h3"
              weight="bold"
